...
def run_training_loop(model, train_loader, val_loader, config, model_name):
    ...
    for epoch in range(config["num_epochs"]):
        ...
        loss_improved = (prev_val_loss - val_loss) > min_delta
        miou_improved = (val_miou - prev_val_miou) > min_delta
        
        if not (loss_improved or miou_improved):
